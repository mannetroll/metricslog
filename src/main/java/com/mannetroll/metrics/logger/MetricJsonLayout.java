...
public class MetricJsonLayout extends AbstractStringLayout {
    ...
    protected MetricJsonLayout(boolean locationInfo, boolean osInfo, String application, Charset charset, boolean b3TracingInfo) {
        super(charset);
    ...
    public static MetricJsonLayout createLayout(@PluginAttribute(value = "locationInfo") boolean locationInfo,
        ...
        return new MetricJsonLayout(locationInfo, osInfo, application, charset ,b3TracingInfo);
    }

    @Override
    public String toSerializable(LogEvent event) {
        try {
            Map<String, Object> logData = metricsData.toJson(event, application, locationInfo, osInfo, b3TracingInfo);
