...
public class MetricJsonLayout extends AbstractStringLayout {
	...
	protected MetricJsonLayout(boolean locationInfo, boolean osInfo, String application, String namespace,
			Charset charset, boolean b3TracingInfo, boolean sort) {
		super(charset);
	...
	public static MetricJsonLayout createLayout(@PluginAttribute(value = "locationInfo") boolean locationInfo,
		...
		return new MetricJsonLayout(locationInfo, osInfo, application, namespace, charset, b3TracingInfo, sort);
	}

	@Override
	public String toSerializable(LogEvent event) {
		try {
			Map<String, Object> logData = metricsData.toJson(event, application, namespace, locationInfo, osInfo,
					b3TracingInfo, sort);
